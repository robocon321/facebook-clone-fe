...
import { getReceiverAccountFriendshipAndStatus, getRecommendAccountFriendship, getSenderAccountFriendshipAndStatus } from "services/AccountService";
...
export const RelationshipContext = createContext<RelationshipContextType | null>(null);
...
const RelationshipProvider = (props: any) => {
    ...
    const [receiveRequest, setReceiveRequest] = useState<PageResponse<AccountWithManualFriendResponse>>(defaultFriendshipRequest);
    const [sendRequest, setSendRequest] = useState<PageResponse<AccountWithManualFriendResponse>>(defaultFriendshipRequest);
    ...
    return (
        <RelationshipContext.Provider value={value}>{props.children}</RelationshipContext.Provider>
    )
}
