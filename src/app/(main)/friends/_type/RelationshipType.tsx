...
export type RelationshipContextType = {    
    ...
    setReceiveRequestFriendship: Dispatch<SetStateAction<PageResponse<AccountWithManualFriendResponse>>>,
    setSendRequestFriendship: Dispatch<SetStateAction<PageResponse<AccountWithManualFriendResponse>>>,
    setRecommendRequestFriendship: Dispatch<SetStateAction<PageResponse<AccountWithManualFriendResponse>>>
};