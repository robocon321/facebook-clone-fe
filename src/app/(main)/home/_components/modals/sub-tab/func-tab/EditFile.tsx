  ...
  return (
    <div className="has-tooltip mb-2">
        ...
        <div className="tooltip invisible absolute flex top-[20px] right-[10px]">
          <IconButton
            click={() =>
              setDataModalState({
                ...dataModalState,
                files: dataModalState.files?.filter(
                  (current) => current.id != fileModal.id
                ),
              })
            }
            icon={faXmark}
          ...
          <button
            onClick={() =>
              changeTabIndexModal(
                ...
                fileModal,
                isVideo
                  ? TAB_VIDEO_NAV_CODE.TEXTAREA
                  : TAB_IMAGE_NAV_CODE.TEXTAREA
              )
            }
      ...
      <textarea
        ...
        className="w-full p-2 outline-none resize-none border border-gray-300 mt-2"
        rows={3}
        placeholder="Note"
    ...
    <div>
      ...
      <div className="flex justify-end mt-2">
        <button
          ...
          className="flex ml-2 items-center justify-between bg-white text-blue-600 min-w-[100px] p-2 rounded hover:bg-gray-200 active:bg-gray-300"
        >
          <span className="mr-2">
        ...
        <button
          onClick={() => changeTabIndexModal(TAB_CODE.MAIN_TAB)}
          className="flex ml-2 items-center justify-between p-2 rounded text-white bg-blue-500 hover:bg-blue-600 active:bg-blue-700"
        >
          Done
        </button>
      </div>
