...
const HomePage: React.FC = () => {
  const { controlModalState, tabModalState, setControlModalState } = useContext(
    ModalContext
  ) as ModalContextType;
  return (
    <div className="w-full h-full grid grid-cols-7">
      ...
      <div className="col-span-3 h-full">
        <Modal
          ...
          isShow={controlModalState.isShowModal}
          width={
            controlModalState.tabIndex >= TAB_CODE_GROUP.DETAIL_FUNC_GROUP
              ? "max-w-[1550px]"
              : controlModalState.tabIndex >= TAB_CODE_GROUP.FUNC_GROUP
              ? "max-w-3xl"
              : "max-w-2xl"
          }
        >
          <div
            ...
            className={
              "flex relative transition-[right] duration-200" +
              (controlModalState.tabIndex >= TAB_CODE_GROUP.DETAIL_FUNC_GROUP
                ? " right-[200%]"
                : controlModalState.tabIndex >= TAB_CODE_GROUP.FUNC_GROUP
                ? " right-[100%]"
